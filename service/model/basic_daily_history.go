...
type BasicDailyHistory struct {
	...
	PriceBatchID    string      `gorm:"column:price_batch_id" json:"price_batch_id"`
...
func (b *BasicDailyHistory) TableName() string {
	return "basic_daily_history"
}
